...
string line_reformat(string input_string){
      string x ("x");
      string date_pattern ("->");
      string time_stamp;
...
string pkt_line_reformat(string input){
...
string full_pkt_line(string line,vector<long>& space_pos_vector){
...
string trailing_line(string line,vector<long>& space_pos_vector){
